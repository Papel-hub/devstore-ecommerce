...
export default function Home() {
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {products.map((product) => (
            <div className="border rounded-lg overflow-hidden shadow hover:shadow-lg transition cursor-pointer bg-white dark:bg-gray-800 flex flex-col">
  ...
  <div className="p-4 flex-1 flex flex-col">
    ...
    <p className="text-lg font-bold text-blue-600 dark:text-blue-400 mt-2">R$ {product.preco}</p>
  </div>
</div>
